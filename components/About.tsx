    ...
    return (
        ...
        >
            <div 
                ...
                className="absolute inset-0 glass-panel rounded-[40px] p-12 flex flex-col justify-between overflow-hidden border-white/5 group-hover:border-yellow-500/30 transition-all duration-500"
            >
                <div className="absolute top-0 right-0 p-8 opacity-20 group-hover:opacity-100 transition-opacity">
                    <ArrowUpRight className="text-yellow-400" size={24} />
                </div>

                <div>
                    <div className="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center mb-10 group-hover:bg-yellow-500 group-hover:text-black transition-all duration-500 border border-white/5 group-hover:shadow-[0_0_30px_rgba(234,179,8,0.4)]">
                        {React.cloneElement(icon, { size: 28, className: "group-hover:scale-110 transition-transform" })}
                    </div>
                    <span className="text-[10px] font-orbitron font-black text-yellow-500/40 tracking-[0.4em] uppercase mb-3 block">
                        {tag}
                    </span>
                    <h3 className="text-3xl font-orbitron font-black mb-6 tracking-tight text-white group-hover:text-yellow-400 transition-colors">
                        {title}
                    </h3>
                ...
                <div className="pt-8 border-t border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] uppercase font-black tracking-[0.3em] text-yellow-500/60">ACTIVE PROTOCOL</span>
                    </div>
                    <Target size={14} className="text-white/5 group-hover:text-yellow-400 transition-colors" />
                </div>

                {/* Animated Gradient Pulse */}
                <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-yellow-500/5 blur-[100px] group-hover:bg-yellow-500/15 transition-all duration-1000" />
            </div>
        </motion.div>
    );
};
        ...
        <div className="mb-32 flex flex-col md:flex-row items-end justify-between gap-16">
          <div className="flex-1">
            <motion.div 
                ...
                className="inline-block px-6 py-2 bg-yellow-500/10 border border-yellow-500/30 rounded-full text-yellow-400 text-[10px] uppercase font-black tracking-[0.4em] mb-8"
            >
            ...
            >
                THE MISSION <br />
                <span className="text-yellow-400 italic">MANIFESTO</span>
            </motion.h2>
          </div>
          <motion.div 
            initial={{ opacity: 0 }}

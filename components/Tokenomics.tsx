    ...
    <section id="tokenomics" className="py-40 px-6 relative z-30 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-32">
          ...
          >
            FUELING THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500 italic">ASCENT</span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(234,179,8,0.05)_0%,transparent_70%)] group-hover:scale-150 transition-transform duration-1000" />
                ...
                <div className="relative w-80 h-80">
                    <motion.div 
                        ...
                        className="absolute inset-0 border-[3px] border-dashed border-yellow-500/40 rounded-full"
                    />
                    <motion.div 
                        animate={{ rotate: -360 }}
                        transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
                        className="absolute inset-8 border border-orange-500/30 rounded-full"
                    />
                    <motion.div 
                        animate={{ scale: [1, 1.1, 1] }}
                        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                        className="absolute inset-16 bg-yellow-500/5 rounded-full blur-2xl"
                    />
                    <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                        <span className="block font-orbitron text-[10px] text-yellow-400 mb-2 uppercase tracking-[0.4em] font-black">Supply Status</span>
                ...
                <motion.div 
                    ...
                    className="absolute top-10 right-10 glass-panel px-6 py-4 rounded-xl border-yellow-500/30"
                >
                ...
                <motion.div 
                    ...
                    className="absolute bottom-10 left-10 glass-panel px-6 py-4 rounded-xl border-orange-500/30"
                >
                    <span className="block text-[8px] text-gray-500 tracking-[0.3em] uppercase mb-1">Growth Index</span>
                    <span className="text-xl font-orbitron font-black text-yellow-400 uppercase">Extreme</span>
                </motion.div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {stats.map((s, i) => (
                    <motion.div
                        ...
                        className="glass-panel p-8 rounded-[32px] group hover:bg-white/[0.04] hover:border-yellow-500/40 transition-all border-l-4 border-l-transparent hover:border-l-yellow-500 h-full"
                    >
                        <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center text-yellow-400 mb-8 group-hover:scale-110 transition-transform">
                            {s.icon}
                        </div>
                        <span className="text-xs text-gray-500 uppercase tracking-[0.4em] font-black mb-2 block">{s.label}</span>
                        <div className="text-4xl font-orbitron font-black text-white group-hover:text-yellow-400 transition-colors mb-3">
                            {s.value}
                        </div>
        ...
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          className="mt-24 p-1 rounded-full bg-gradient-to-r from-transparent via-yellow-500/50 to-transparent max-w-4xl mx-auto"
        >

  ...
  return (
    <>
      <motion.nav 
        ...
        className="fixed top-0 left-0 right-0 z-[110] px-6 py-6"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              <div className="flex items-center gap-6">
                <a href="#" className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-white hover:bg-cyan-500/20 hover:text-cyan-400 transition-all">
                  <Twitter size={20} />
                </a>
                <a href="#" className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-white hover:bg-cyan-500/20 hover:text-cyan-400 transition-all">
